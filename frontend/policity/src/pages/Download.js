...
const Download = () => {
    ...
    const reportUrlPath =
        finalReportData?.report_url || finalReportData?.result?.report_url;
                ...
                <div style={{ display: "flex", gap: "15px" }}>
                    ...
                    <button
                        ...
                        style={{
                            ...
                            fontSize: "14px",
                            fontWeight: "bold",
                            backgroundColor: pdfUrl ? "#b084cc" : "#bdc3c7",
                            color: "white",
                            border: "none",
                            borderRadius: "8px",
                            cursor: pdfUrl ? "pointer" : "not-allowed",
                            boxShadow: pdfUrl
                                ? "0 4px 6px rgba(176, 132, 204, 0.3)"
                                : "none",
                        }}
                    >
                        Download PDF
                ...
                {isLoadingPdf ? (
                    <div style={{ textAlign: "center" }}>
                        ...
                        <p
                            ...
                            style={{ color: "#7f8c8d", fontWeight: "500" }}
                        >
                    ...
                    >
                        ...
                        <p>
                            We couldn't locate the document. It may have failed
                            to generate.
                        </p>
                    </div>
                )}
